...
export default async function setProps() {
  ...
  properties.playWord = localStorage.getItem('playWord');
  properties.playWordExample = localStorage.getItem('playWordExample');
  properties.playWordMeaning = localStorage.getItem('playWordMeaning');
}
