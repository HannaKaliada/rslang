...
export default function renderMenu() {
  ...
  menuWrapper.insertAdjacentHTML('beforeend', `
    ...
    <div class="menu__items">
      ...
      <a class="menu__item" href="#/vocabluary">
        <div class="menu-item__icon" data-toggle="tooltip" data-placement="right" title="Vocabluary">
        ...
        <div class="menu-item__label">Vocabluary</div>
      </a>
